...
void usbip_net_pack_usb_device(int pack, struct usbip_usb_device *usbip_dev)
{
	usbip_net_pack_uint32_t(pack, &usbip_dev->busnum);
	usbip_net_pack_uint32_t(pack, &usbip_dev->devnum);
	usbip_net_pack_uint32_t(pack, &usbip_dev->speed);

	usbip_net_pack_uint16_t(pack, &usbip_dev->idVendor);
	usbip_net_pack_uint16_t(pack, &usbip_dev->idProduct);
	usbip_net_pack_uint16_t(pack, &usbip_dev->bcdDevice);
}

void usbip_net_pack_usb_interface(int pack UNUSED,	struct usbip_usb_interface *usbip_inf UNUSED)
{
